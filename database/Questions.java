...
public class Questions 
{
	...
	private final static int LENGTH_OF_FILE = END_OF_NAME + LENGTH_OF_PATH + 1;
	...
	public static void addQuestion(String name, String filePath)
	{
		...
		try
		{
			...
			fw.write(id + fixedName + fixedPath + "\n");
			fw.close();
		}
		catch(Exception e)
		{
	...
	public static String getFilePath(int index)
	{
		...
		try
		{
			...
			String line = raf.readLine();
			filePath = line.substring(END_OF_NAME, LENGTH_OF_FILE);
		}
		catch(Exception e)
		{
			System.out.println("error " + e);
